...
On Success Returns Array of Arrays:
```
[{
  "id": 0,
  "created_at": "time",
...
### Story Resources
#### GET -> 'api/storys'
This will return the most recent top level skribbls
Accepts: (nothing but the request)
On Failure Returns Blank Array: `[]`  *(status: 500)*
On Success Returns Array of 20 skribbls:
```
...
#### GET -> 'api/storys/id'
When passed a top-level id, this will find & return the next 20 top level skribbls after it.
(good for querying next 20 on infinite scroll)
Accepts: unique ID number for individual skribbl item (story_id is always a top-level _id).
On Failure Returns Blank Array: `[]`  *(status: 500)*
On Success Returns Array of skribbls:
```
[ { _id: '555cf2291d0df88cd17430ae',
    content: 'Calabunga icky sickly pinky raddical dippy sickly tuff trippy. Calabunga ritious magical sickly calabunga pinky dippy. Goat ritious gnar holy metal. Icky tuff epic turnt goat magical apple raddical apple.',
    created_at: '2015-05-20T20:44:25.121Z',
